...
export async function runDuelSimulation(room) {
  ...
  const result = simulateMatch({
    seed,
    home: { key: "creator", players: creatorSide.players, formation: creatorSide.squad?.formation || null },
    away: { key: "joiner", players: joinerSide.players, formation: joinerSide.squad?.formation || null },
