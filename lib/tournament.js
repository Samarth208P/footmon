 ...
 * }}
 */
export function runTournament({ seed, players }) {
  ...
  const ladder = buildTournamentLadder({
    seed,
    playerRating: rating,
  ...
  for (const rung of ladder) {
    ...
    // A draw does not advance you: this is a knockout.
 ...
 *
 * ⚠️ Keep in sync with buildTournamentMessage() in public/js/tournament.js.
 */
export function buildTournamentMessage({ address, squadHash, issuedAt, nonce }) {
  return [
